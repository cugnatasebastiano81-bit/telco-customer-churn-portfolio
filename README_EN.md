...
training distribution, and keeps the final holdout set untouched until every
modeling decision is locked.

The notebook is written in Italian. This English page summarizes the method and
results for an international audience.
